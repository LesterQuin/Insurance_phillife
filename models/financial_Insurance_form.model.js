...
export const getExtensionRequests = async (userIds = null) => {
    ...
    let query = `SELECT application_id FROM DHUB_UAT.sg.financial_insurance_application WHERE extension_requested = 1 AND status_id NOT IN (6, 7)`;
...
export const getExtensionRequestsPaginated = async (userIds = null, page = 1, limit = 10, filters = {}) => {
    ...
    let whereClause = "WHERE fia.extension_requested = 1 AND fia.status_id NOT IN (6, 7)";
