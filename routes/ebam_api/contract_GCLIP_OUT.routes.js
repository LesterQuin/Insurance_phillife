...
router.get('/:id/policy-contract/outstanding/underwriting-limits', authenticate, Controller.getUnderwritingLimits);
router.post('/:id/policy-contract/outstanding/underwriting-limits', authenticate, Controller.saveUnderwritingLimits); // done
...
router.post('/:id/policy-contract/outstanding/contribution', authenticate, Controller.saveContribution); // done
...
router.post('/:id/policy-contract/outstanding/eligible-individuals', authenticate, Controller.saveEligibleIndividuals); // done
router.put('/:id/policy-contract/outstanding/eligible-individuals', authenticate, Controller.saveEligibleIndividuals);
...
router.post('/:id/policy-contract/outstanding/participation-requirements', authenticate, Controller.saveParticipationRequirements); // done
...
router.post('/:id/policy-contract/outstanding/special-provisions', authenticate, Controller.saveSpecialProvisions);
...
router.post('/:id/policy-contract/outstanding/schedule-of-insurance', authenticate, Controller.saveScheduleOfInsurance); // done
router.put('/:id/policy-contract/outstanding/schedule-of-insurance', authenticate, Controller.saveScheduleOfInsurance);
