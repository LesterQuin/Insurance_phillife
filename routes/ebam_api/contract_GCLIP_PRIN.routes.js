...
router.put('/:id/policy-contract/principal/underwriting-limits', Controller.saveUnderwritingLimits);

// Contribution Management APIs
router.get('/:id/policy-contract/principal/contribution', Controller.getContribution);
router.post('/:id/policy-contract/principal/contribution', Controller.saveContribution);
router.put('/:id/policy-contract/principal/contribution', Controller.saveContribution);

// Eligible Individuals Management APIs
router.get('/:id/policy-contract/principal/eligible-individuals', Controller.getEligibleIndividuals);
...
router.get('/:id/policy-contract/principal/participation-requirements', Controller.getParticipationRequirements);
router.post('/:id/policy-contract/principal/participation-requirements', Controller.saveParticipationRequirements);
router.put('/:id/policy-contract/principal/participation-requirements', Controller.saveParticipationRequirements);

// Special Underwriting Provisions Sections Management APIs
router.get('/:id/policy-contract/principal/special-provisions', Controller.getSpecialProvisions);
router.post('/:id/policy-contract/principal/special-provisions', Controller.saveSpecialProvisions);
router.put('/:id/policy-contract/principal/special-provisions', Controller.saveSpecialProvisions);

// Unified Schedule of Insurance APIs
router.get('/:id/policy-contract/principal/schedule-of-insurance', Controller.getScheduleOfInsurance);
