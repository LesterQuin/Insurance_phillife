...
/**
 * Group Credit Life Insurance Outstanding (GCLI Principal) Policy Contract Template
 ...
 */
export function generateGCLIPrincipalPolicyContract(application = {}, details = {}, riderTemplatesHtml = '') {
    ...
    const basicPlanName = application?.basic_plan_name || application?.plan_name || 'Group Credit Life Insurance (Initial Loan Amount)';
    ...
    const getSpecialUnderwritingProvisionsHtml = () => {
        ...
        const faceAmount = application.provision_face_amount ?? '';
        const premiumComp = application.provision_premium_computation ?? '';
        const nonCoverage = application.provision_non_coverage ?? '';
...
<body>
    ...
    <div class="page-container">
            ...
            <tbody>
                ...
                <tr style="page-break-inside: avoid; break-inside: avoid;">
                    <td colspan="2" style="font-style: italic; font-size: 9pt; line-height: 1.45; text-align: left; border: 1px solid #000; padding: 8px 12px; background-color: #ffffff;">
                        ...
                        <strong style="font-weight: bold;">Premium = Initial Loan Amount / 1,000 * ${(application?.payment_mode_name || 'Monthly')} Rate * Term of Loan in Months</strong>
                    </td>
                </tr>
        ...
        <p class="paragraph">
            This Policy shall be kept in the main office and in the custody of an officer of the Creditor. It will be available to the Insured Debtors for their inspection during regular business hours of         <div class="provisions-section-header">POLICY DATA PAGE PROVISIONS</div>
        <p class="paragraph">
        ...
        ` + (details.showSignoff !== false ? `<!-- ================= PAGE 23: SIGN-OFF CHECKLIST ================= -->
