        ...
        <div class="sla-container">
            ...
            <table class="sla-table">
                ...
                <tr style="background-color: #ffff00; font-weight: bold; font-size: 9pt;">
                    <td colspan="6" style="border: 1px solid #000; padding: 3px 6px; text-transform: uppercase;">QUOTATION</td>
                </tr>
                <tr>
                ...
                <tr style="background-color: #ffff00; font-weight: bold; font-size: 9pt;">
                    <td colspan="6" style="border: 1px solid #000; padding: 3px 6px; text-transform: uppercase;">NEGOTIATION</td>
                </tr>
                <tr>
                ...
                <tr style="background-color: #ffff00; font-weight: bold; font-size: 9pt;">
                    <td colspan="6" style="border: 1px solid #000; padding: 3px 6px; text-transform: uppercase;">NEW BUSINESS</td>
                </tr>
                <tr>
                ...
                <tr style="background-color: #ffff00; font-weight: bold; font-size: 9pt;">
                    <td colspan="6" style="border: 1px solid #000; padding: 3px 6px; text-transform: uppercase;">UNDERWRITING</td>
                </tr>
                <tr>
                ...
                <!-- Category: ISSUANCE -->
                <tr style="background-color: #ffff00; font-weight: bold; font-size: 9pt;">
                    <td colspan="6" style="border: 1px solid #000; padding: 3px 6px; text-transform: uppercase;">ISSUANCE</td>
                </tr>
                <tr>
                ...
                <tr style="background-color: #ffff00; font-weight: bold; font-size: 9pt;">
                    <td colspan="6" style="border: 1px solid #000; padding: 3px 6px; text-transform: uppercase;">CANCELLATION</td>
                </tr>
                <tr>
                ...
                <!-- Category: BILLING -->
                <tr style="background-color: #ffff00; font-weight: bold; font-size: 9pt;">
                    <td colspan="6" style="border: 1px solid #000; padding: 3px 6px; text-transform: uppercase;">BILLING</td>
                </tr>
                <tr>
                ...
                <!-- Category: COLLECTION -->
                <tr style="background-color: #ffff00; font-weight: bold; font-size: 9pt;">
                    <td colspan="6" style="border: 1px solid #000; padding: 3px 6px; text-transform: uppercase;">COLLECTION</td>
                </tr>
                <tr>
                    <td>First Premium</td>
                    <td>10</td>
                ...
                <tr>
                    <td>Addition/Deletion (Adjustment)</td>
                    <td>10</td>
                    <td>Due Date</td>
                    <td>Printed copy, email</td>
                    <td>Policyholder</td>
                ...
                <!-- Category: CLAIMS -->
                <tr style="background-color: #ffff00; font-weight: bold; font-size: 9pt;">
                    <td colspan="6" style="border: 1px solid #000; padding: 3px 6px; text-transform: uppercase;">CLAIMS</td>
                </tr>
                <tr>
                    <td>Evaluation/Decision</td>
                    <td>15</td>
                    <td>Submission of Claims Requirements</td>
                    <td>Printed copy, email</td>
                    <td>PhilLife</td>
                    <td>Claims</td>
                </tr>
                ...
                <!-- Category: REPORTS -->
                <tr style="background-color: #ffff00; font-weight: bold; font-size: 9pt;">
                    <td colspan="6" style="border: 1px solid #000; padding: 3px 6px; text-transform: uppercase;">REPORTS</td>
                </tr>
                <tr>
                    <td>Policy Issuance (Monthly)</td>
                    <td></td>
                    <td>Submission Report</td>
                    <td>Printed copy, email</td>
                    <td>PhilLife</td>
                    <td>ebam@phillife.com.ph</td>
                </tr>
                <tr>
                    <td>Client Monies Reconciliation (Annual)</td>
                    <td></td>
                    <td>Submission Report</td>
                    <td>Printed copy, email</td>
                    <td>Policyholder/Phillife</td>
                    <td>ebam@phillife.com.ph/GMS</td>
                </tr>

                <!-- Category: COMMUNICATION -->
                <tr style="background-color: #ffff00; font-weight: bold; font-size: 9pt;">
                    <td colspan="6" style="border: 1px solid #000; padding: 3px 6px; text-transform: uppercase;">COMMUNICATION</td>
                </tr>
                <tr>
                    <td rowspan="2">Acknowledgement</td>
                    <td>2</td>
                    <td>Simple: working dates from the receipt of the complain/request</td>
                    <td>Email</td>
                    <td>Policyholder/Phillife</td>
                    <td>ebam@phillife.com.ph/GMS</td>
                </tr>
                <tr>
                    <td>2</td>
                    <td>Complex: working dates from the receipt of the complain/request</td>
                    <td>Email</td>
                    <td>Policyholder/Phillife</td>
                    <td>ebam@phillife.com.ph/GMS</td>
                </tr>
                <tr>
                    <td rowspan="2">Processing and Resolution<br>(assessment, investigation, & resolution)</td>
                    <td>7</td>
                    <td>Simple: working dates from the receipt of the complain/request</td>
                    <td>Email</td>
                    <td>Policyholder/Phillife</td>
                ...
                <tr>
                    <td rowspan="2">Communication of resolution to requesting consumer</td>
                    <td>9</td>
                    <td>Simple: working dates from the receipt of the complain/request</td>
                    <td>Email</td>
                    <td>Policyholder/Phillife</td>
                ...
                <tr>
                    <td>Audit/Reconciliation Report</td>
                    <td>30</td>
                    <td>Within 30 calendar days after end of each quarter</td>
                    <td>Printed copy, email</td>
                    <td>Audit/Phillife</td>
                    <td>ebam@phillife.com.ph/Audit</td>
                </tr>
                </tbody>
            </table>
        </div>
