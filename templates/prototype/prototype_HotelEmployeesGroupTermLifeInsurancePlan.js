    ...
    <div class="subsequent-header-gradient"></div>
        <p>
            ...
            <ul style="margin-top: -10px; margin-bottom: 15px; padding-left: 20px;">
                ...
                <li style="text-align: justify; font-size: 11pt; line-height: 1.6;">Group Accidental Death Benefit Rider (GADBR)</li>
                <li style="text-align: justify; font-size: 11pt; line-height: 1.6;">Group Hospital Income Rider (GHIR)</li>
                <li style="text-align: justify; font-size: 11pt; line-height: 1.6;">Group Terminal Illness Rider (GTIR)</li>
            </ul>
