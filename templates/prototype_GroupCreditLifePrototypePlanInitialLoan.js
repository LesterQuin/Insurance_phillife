...
<body>
    ...
    <p>We are pleased to present to you our <strong>${application.basic_plan?.name || ''} – Initial Loan Amount</strong> for the benefit of <strong>${application.group_name || ''} - debtors</strong>.</p>
