/**
 * Group Accidental Death Benefit Rider (GADBR) Template
 ...
 */
export const generateGADBRTemplate = (application = {}, details = {}, rider = {}) => {
    ...
    const riderName = rider?.rider_name || 'Group Accidental Death Benefit Rider';
    const acronym = rider?.acronym || 'GADBR';
...
<body>
    ...
    <div class="rider-container">
        ...
        <div class="section-title">Accidental Death Benefit</div>
        <p class="section-content paragraph">
            Upon receipt and approval by the Insurer of due proof that an Insured has sustained accidental bodily injuries effected directly and independently of all other causes and as a result of such injuries has died, within one hundred eighty (180) days after the date of accident, the Insurer shall, subject to the limitations and provisions hereunder and of the Policy, pay his beneficiaries, the amount of insurance under this Rider. This is in addition to the amount of insurance payable under the Policy, if any.
        </p>
