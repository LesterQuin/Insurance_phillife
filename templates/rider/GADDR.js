/**
 * Group Accidental Death and Disability Rider (GADDR) Template
 ...
 */
export const generateGADDRTemplate = (application = {}, details = {}, rider = {}) => {
    ...
    const riderName = rider?.rider_name || 'Group Accidental Death and Disability Rider';
    const acronym = rider?.acronym || 'GADDR';
        ...
        <table class="indemnity-table">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center; width: 220px; padding: 8px 12px !important; line-height: 1.2;">
                        PERCENTAGE OF AMOUNT<br>OF INSURANCE
                    </th>
                </tr>
            </thead>
            <tbody>
