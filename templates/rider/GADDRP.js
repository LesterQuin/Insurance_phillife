/**
 * Group Accidental Death and Disability Rider Plus (GADDR+) Template
 ...
 */
export const generateGADDRPTemplate = (application = {}, details = {}, rider = {}) => {
    ...
    const riderName = 'Group Accidental Death and Disability Rider Plus';
    const acronym = 'GADDR+';
...
<body>
    ...
    <div class="rider-container">
        ...
        <table class="indemnity-table">
            <thead>
                <tr>
                    <th style="text-align: left; padding: 8px 12px !important;">Description</th>
            ...
            <tbody>
                ...
                <tr>
                    <td>Injuries resulting in being permanently bedridden</td>
                    <td>100%</td>
                </tr>
                <tr>
                    <td>Any other injury causing permanent total disability</td>
                    <td>100%</td>
                </tr>
                <tr>
