/**
 * Group Special Accidental Death and Disability Rider (GADDSR) Template
 ...
 */
export const generateGADDSRTemplate = (application = {}, details = {}, rider = {}) => {
    ...
    const riderName = rider?.rider_name || 'Group Special Accidental Death and Disability Rider';
    const acronym = rider?.acronym || 'GADDSR';
...
<head>
    ...
    <style>
        ...
        .indemnity-table th, .indemnity-table td {
        ...
        .indemnity-table tr td:first-child {
            font-weight: normal;
            color: #202124;
            text-align: left;
        }
        .indemnity-table tr td:last-child {
            text-align: center;
            font-weight: bold;
            color: #202124;
        }
...
<body>
    ...
    <div class="rider-container">
        ...
        <div class="section-title">Accidental Death and Disability Benefit</div>
        <p class="section-content paragraph">
            Upon receipt and approval by the Insurer of due proof that an Insured has sustained accidental bodily injuries effected directly and independently of all other causes and as a result of such injuries has sustained, within one hundred eighty (180) days after the date of accident, any of the losses enumerated in the Schedule of Indemnities, the Insurer shall, subject to the limitations and provisions hereunder and of the Policy, pay to the Insured, if living, otherwise to his beneficiaries, the amount specified for such loss in the Schedule of Indemnities. This is in addition to the amount of insurance payable under the Policy, if any.
        </p>

        <div class="section-title">Schedule of Indemnities</div>
        <table class="indemnity-table">
            <thead>
                <tr>
                    <th style="text-align: left; padding: 8px 10px !important;">Description</th>
                    <th style="text-align: center; width: 220px; padding: 8px 50px !important; line-height: 1.2;">
            ...
            <tbody>
                ...
                <tr>
                    <td>Loss of both hands</td>
                    <td>100%</td>
                </tr>
                <tr>
                    <td>Loss of arm at or above elbow</td>
                    <td>70%</td>
                </tr>
                <tr>
                    <td>Loss of arm between elbow and wrist</td>
                    <td>60%</td>
                </tr>
                <tr>
                    <td>Loss of one hand</td>
                    <td>50%</td>
                </tr>
                <tr>
                    <td>Loss of all fingers of one hand</td>
                    <td>50%</td>
                </tr>
                <tr>
                    <td>Loss of thumb</td>
                ...
                <tr>
                    <td>Loss of middle, ring or little finger</td>
                    <td>6%</td>
                </tr>
                <tr>
                    <td>Loss of both feet</td>
                    <td>100%</td>
                </tr>
                <tr>
                    <td>Loss of leg at or above knee</td>
                    <td>70%</td>
                </tr>
                <tr>
                    <td>Loss of leg below knee</td>
                    <td>60%</td>
                </tr>
                <tr>
                    <td>Loss of one foot</td>
                    <td>50%</td>
                </tr>
                <tr>
                    <td>Loss of all toes of one foot</td>
                    <td>30%</td>
                </tr>
                <tr>
                    <td>Loss of any toe</td>
                    <td>4%</td>
                </tr>
                <tr>
                    <td>Total loss of sight of both eyes</td>
                    <td>100%</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Loss of hearing of both ears</td>
                    <td>100%</td>
                </tr>
                <tr>
                    <td>Loss of hearing - one ear</td>
                    <td>50%</td>
                </tr>
            </tbody>
        </table>

        <p class="section-content paragraph" style="text-indent: 0; font-weight: 500;">
        ...
        <p class="section-content paragraph">
            The loss of more than one phalange of the thumb or of any other finger or of any toe shall be treated as loss of the entire thumb or finger or toe.
        </p>
        <p class="section-content paragraph">
            The total benefits payable under this Rider in respect to any one accident resulting in loss(es) within 180 days from the date of such accident(s) shall not exceed the Insured’s amount of insurance.
        </p>
        <p class="section-content paragraph">
            The aggregate disability benefits payable, including benefits for accident(s) resulting in loss(es) within 180 days from the date of accident(s) shall not exceed the Insured’s amount of insurance, i.e., for any subsequent accident resulting in any loss(es) which would make the aggregate disability benefits exceed the Insured’s amount of insurance, the amount payable under this Rider shall be his amount of insurance less any amount(s) paid for previous loss(es). However, the payment of his amount of insurance for such loss(es) shall not terminate his insurance in so far as accidental death benefit is concerned.
        </p>
        <p class="section-content paragraph">
        ...
        <p class="section-content paragraph" style="margin-bottom: 25px;">
        ...
        <p class="section-content" style="margin-bottom: 10px;">
            No payment shall be made under this Rider for any loss resulting from or caused directly or wholly, by:
        </p>
        <ol>
