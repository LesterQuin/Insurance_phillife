/**
 * Group Total and Permanent Disability Rider for Creditors (GTPDRC) Template
 * 
 ...
 */
export default function generateGTPDRCTemplate(application = {}, details = {}, rider = {}) {
    ...
    const riderName = rider?.rider_name || 'GROUP TOTAL AND PERMANENT DISABILITY RIDER FOR CREDITORS';
    const acronym = rider?.acronym || 'GTPDRC';
...
<body>
    ...
    <div class="rider-container">
        ...
        <p class="paragraph">
            This Rider forms part of the Policy if its description title is indicated in the Policy Data Page. The following conditions shall apply only to this Rider and not to any other portion of the Policy to which this Rider is attached, herein referred to simply as the Policy, unless specifically provided otherwise.
        </p>
        <p class="paragraph">
        ...
        <p class="section-content">
            The Creditor shall be entitled to receive the amount of insurance under this Rider to the extent of the Insured Debtor’s outstanding balance if such Insured Debtor:
        </p>
        ...
        <p class="section-content paragraph">
            Such amount paid shall be applied by the Creditor to reduce or completely extinguish the outstanding loan balance of the Insured Debtor to the Creditor.
        </p>
        <p class="section-content paragraph">
            Upon availment of said benefit, all insurance under the Policy with respect to such Insured Debtor shall immediately cease.
        </p>
        ...
        <ol style="list-style-type: decimal;">
            <li>Any attempt at self-destruction while sane or insane</li>
            <li>Disease which originated, or bodily injury which occurred, before the effective date of this Rider if the Insured Debtor received medical or surgical treatment for such disease or injury within three (3) years immediately before such effective date, unless such treatment was disclosed in the application for coverage</li>
        ...
        <p class="section-content paragraph">
            The Creditor may discontinue this Rider at any time by giving written notice to the Insurer at least 31 days prior to the date of termination.
        </p>
        <p class="section-content">
        ...
        <ol style="list-style-type: decimal;">
            ...
            <li>Attainment of the Insured Debtor of the termination age for this Rider as stated in the Policy Data Page</li>
            <li>Termination of the Insured Debtor’s individual insurance under the Policy</li>
        </ol>
        <p class="section-content paragraph">
